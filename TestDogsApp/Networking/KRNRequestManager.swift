...
class KRNRequestManager {
    ...
    //MARK: Requests
    func requestJSON(method : HttpMethod, shortURL : String, params : [String : Any]?, headerParams : [String : String]?, parseFormat : KRNParseResponseFormat = .json, completion : @escaping ResponseCompletion) -> Void  {
    ...
    func requestMultiEncoded(method : HttpMethod, shortURL : String, urlParams : [String : String]?, params : [String : Any]?, headerParams : [String : String]?, parseFormat : KRNParseResponseFormat = .json, completion : @escaping ResponseCompletion) -> Void {
    ...
    func requestURLQuery(method : HttpMethod, shortURL : String, urlParams : [String : String]?, headerParams : [String : String]?, parseFormat : KRNParseResponseFormat = .json, completion :  @escaping ResponseCompletion) {
